...
#include "CardEvaluatorBFL.generated.h"
...
UCLASS()
class BOARDCARDGAMEPLUGIN_API UCardEvaluatorBFL : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()

public:
    UFUNCTION(BlueprintCallable)
    static int EvaluateCards(TArray<struct FClassicCardStruct> Cards);
...
public:
    ...
    bool isFlush() const {
        return UCardEvaluatorBFL::is_flush(value_);
    }
