...
#include "PHPokerCardEvaluator.generated.h"
...
class BOARDCARDGAMEPLUGIN_API UPHPokerCardEvaluator : public UPHCardEvaluator
{
    GENERATED_BODY()

//public:
//    UFUNCTION(BlueprintCallable)
//    virtual int EvaluateCards(TArray<struct FBCG_DataStruct> Cards) override;
//
//    UFUNCTION(BlueprintCallable, BlueprintPure)
//    FText GetHandValueAsText(int value);
//
...
//
//    bool isFlush() const {
//        return UPHPokerCardEvaluator::is_flush(value_);
//    }
//
